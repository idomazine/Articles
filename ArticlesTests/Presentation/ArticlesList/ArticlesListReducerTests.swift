...
struct ArticlesListReducerTests {
  ...
  func loadArticles_success() async throws {
    ...
    store.dependencies.apiClient.getArticlesWithPage = { _ in
      ArticlesListAPIResponse.sample
    }
...
private extension ArticlesListAPIResponse {
  static var sample: ArticlesListAPIResponse {
    .init(articles:
            [
              ArticleAPIResponse(
                id: 101,
